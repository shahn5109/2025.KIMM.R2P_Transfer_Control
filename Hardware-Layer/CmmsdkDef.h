...
typedef enum _TCmMioPropIdEx{
	...
	cmMPID_ERC_ONTIME,	cmMPID_SVON_LOGIC,	cmMPID_ERC_OUT_EL,	cmMPID_CNT_D_SRC,	cmMPID_CNT_G_SRC
}TCmMioPropIdEx;
...
#define cmERR_INVALID_ARC_POS		-5190 // Arc-interpolation position data is invalid
