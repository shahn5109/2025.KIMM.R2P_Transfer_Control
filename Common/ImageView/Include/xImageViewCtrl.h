...
public:
	...
	//////////////////////////////////////////////////////////////////////////
	// Behavior
	//void SetMiniButtonType( DWORD dwMBType, BOOL bMaximize );  - JH
	...
	//BOOL SetAnimateWindow( BOOL bEnable ); - JH

	void GetTitleRect( LPRECT lpRect );

	void SetTitleColor( DWORD dwBodyStartColor, DWORD dwBodyEndColor, DWORD dwInactiveTextColor, DWORD dwActiveTextColor );
	...
	//void SetBorderColor( DWORD dwOutlineBorderColor, DWORD dwInnerBorderColor );
	...
	void SetImageObject( CImageObj* pImageObject, BOOL bZoomFit=TRUE );
	// get current viewing image object pointer
	CImageObj* GetVisibleImageObject();
	...
	CxImageScrollView* GetInnerView();
	...
	void SetMouseWheelMode( CxImageScrollView::MouseWheelMode eMouseWheelMode );
	CxImageScrollView::MouseWheelMode GetMouseWheelMode() const;
	...
	CPoint GetMousePositionOnImage() { return m_ptPixel; }
...
protected:
	...
	CxImageScrollView::ScreenMode m_eOldScreenModeForTracker;
	...
	COLORREF	m_dwBorderColors[2];		// 0: Outline, 1: Innerline
	COLORREF	m_dwTitleBodyColor[2];
	...
	COLORREF	m_dwTitleBodyGradientColor[2];
